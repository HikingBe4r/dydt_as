 ...
 */
public class SwipeCustomTouchListener implements View.OnTouchListener {
     ...
     *                 dismiss this view.
     */
    public SwipeCustomTouchListener(View view, Object token, DismissCallbacks callbacks) {
